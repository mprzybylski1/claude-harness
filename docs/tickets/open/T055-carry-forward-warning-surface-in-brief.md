...
- [ ] When `extract_carry_forwards.py` emits its "could not determine current session"
...
- [ ] The warning reaches the user regardless of whether the caller is used interactively
      or via subprocess.
